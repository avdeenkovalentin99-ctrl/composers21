...
export function ComposerPage() {
  ...
  const composer = findComposerBySlug(slug);
  ...
  const imageClassName =
    composer.slug === "leonid-desyatnikov"
      ...
      : "aspect-[4/5] w-full object-cover grayscale";
                ...
                <div className="relative w-full">
                  ...
                  <div className={BIOGRAPHY_STANDARD_MEDIA_GRID_CLASS}>
                    <motion.span
                      ...
                      className="absolute bottom-0 left-[-22px] hidden rotate-180 whitespace-nowrap font-editorial-sans font-small-caps text-[0.96rem] font-normal tracking-[0.18em] text-neutral-900/72 [writing-mode:vertical-rl] lg:block"
                    >
                      {composer.name}
                    </motion.span>
